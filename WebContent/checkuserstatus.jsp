...
<%
    try{
        ...
        PreparedStatement pst = conn.prepareStatement("select c.c_id,c.name,c.mob_no,i.item_id,i.type,i.weight,s.address_of_sender,s.address_of_receiver,s.status from customer c,item i,shipment s where i.item_id=? and i.item_id=c.item_id and s.item_id=i.item_id");
