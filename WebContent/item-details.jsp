...
<%
    ...
    PreparedStatement pst = conn.prepareStatement("select i.item_id,i.type,i.weight,s.address_of_sender,s.address_of_receiver,s.status from item i,customer c,shipment s where c.c_id=? and i.item_id = c.item_id and s.item_id=i.item_id");
